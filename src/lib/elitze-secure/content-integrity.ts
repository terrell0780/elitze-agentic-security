import { Decision, EvidenceState } from "../core/decision.js";
export interface ContentAssessment { provenanceVerified:boolean; evidenceVerified:boolean; uniqueness:number|null; factuality:number|null; staleness:number|null; evidenceState:EvidenceState; hardFailure:boolean; }
